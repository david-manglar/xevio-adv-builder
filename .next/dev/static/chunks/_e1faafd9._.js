...
;
;
function StepTwo({ stepOneData, data, updateData, onNext, onBack, isLoading, onCampaignCreated, userId }) {
    _s();
    ...
    const handleNext = async ()=>{
        ...
        try {
            // Call our internal API to create the campaign record
            // This triggers scraping in background via n8n webhook
            ...
            // Update campaign data with the new campaign ID and scraping status
            onCampaignCreated({
                id: campaignId,
                status: "scraping"
            });
            // Proceed immediately to next step - scraping happens in background
            // User can work on Building Blocks while scraping completes
            onNext();
        } catch (error) {
...
_s(StepTwo, "MAEufnJIy0s01oVCoDcHXEObhzA=");
_c = StepTwo;
var _c;
...
//# sourceMappingURL=_e1faafd9._.js.map