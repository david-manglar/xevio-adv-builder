...
"[project]/app/api/save-progress/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const { error: dbError } = await supabase.from('campaigns').update(updateData).eq('id', campaignId);
        if (dbError) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__06a7b7a9._.js.map