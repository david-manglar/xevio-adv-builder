...
"[project]/app/api/campaign/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const { data: campaign, error } = await supabase.from('campaigns').select(`
        id,
        topic,
        campaign_type,
        niche,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ea131a74._.js.map