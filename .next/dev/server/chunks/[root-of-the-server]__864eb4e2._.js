    ...
    try {
        ...
        const urlsWithContext = validUrls.map((ref)=>{
            if (typeof ref === 'string') {
                return {
                    url: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$url$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cleanUrl"])(ref),
                    description: null
                };
            }
            return {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__864eb4e2._.js.map