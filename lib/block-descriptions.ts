export const blockDescriptions: Record<string, { description: string; promptPreview?: string }> = {
  ...
  // Problem & Solution
  "x-reasons": {
    description: "A numbered list of clear, logical reasons why the topic/product/problem matters. Input how many reasons to generate.",
  ...
  "cta": {
    description: "A direct, clear call-to-action. Maximum 60 characters (ideally ~30). Must contain a specific action.",
